...
public class menuShowsBlockAccount {
    public void menuShowsBlockAccount() {
        JFrame frame = new JFrame("Получение Заблокированных счетов");
        ...
        submitButton.addActionListener(e -> {
            ...
            StringBuilder result = new showsBlockAccount().showsBlockAccount(number);
            if (result == null) {
