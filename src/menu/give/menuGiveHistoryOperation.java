...
public class menuGiveHistoryOperation {
    public void menuGiveHistoryOperation() {
        JFrame frame = new JFrame("Получение историй операций по счету");
        ...
        submitButton.addActionListener(e -> {
            ...
            StringBuilder result = new readHistoryOperation().readHistoryOperation("moneyaccount_" + number);
            if (result == null) {
