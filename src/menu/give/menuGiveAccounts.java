...
import accessDataBase.read.readBankAccount;
...
public class menuGiveAccounts {
    public void menuGiveAccounts() {
        JFrame frame = new JFrame("Получение данных о счете");
        ...
        submitButton.addActionListener(e -> {
            ...
            StringBuilder result = new readBankAccount().readBankAccount(number);
            if (result == null) {
...
//        System.out.println("Если хотите увидеть весь список просто введите 0");
//        int number = new nameAccount().nameAccount();
//
//        new readBankAccount().readBankAccount(number);
    }
}
